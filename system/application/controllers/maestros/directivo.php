...
class Directivo extends Controller {
    ...
    ###########################
        ...
        public function guardar_registro(){
            $codigo_para_empleado_cliente = $this->input->post("codigo_para_empleado_cliente");
            if ($codigo_para_empleado_cliente == "0") {
                ...
                $empleado           = $this->input->post("empleado_empleado"); # DIRECTIVO
                $tipo_documento     = $this->input->post("tipo_documento_empleado");
                $numero_documento   = $this->input->post("numero_documento_empleado");
                $numero_ruc         = $this->input->post("numero_ruc_empleado");
                $nombres            = strtoupper( $this->input->post("nombres_empleado") );
                $apellido_paterno   = strtoupper( $this->input->post("apellido_paterno_empleado") );
                $apellido_materno   = strtoupper( $this->input->post("apellido_materno_empleado") );
                $fecha_nacimiento   = $this->input->post("fecha_nacimiento_empleado");
                $genero             = $this->input->post("genero_empleado");
                $edo_civil          = $this->input->post("edo_civil_empleado");
                $nacionalidad       = $this->input->post("nacionalidad_empleado");
                $direccion          = strtoupper( $this->input->post("direccion_empleado") );
                
                $telefono           = $this->input->post("telefono_empleado");
                $movil              = $this->input->post("movil_empleado");
                $fax                = $this->input->post("fax_empleado");
                $correo             = $this->input->post("correo_empleado");
                $web                = $this->input->post("web_empleado");
                
                $banco              = $this->input->post("banco_empleado");
                $cta_soles          = $this->input->post("cta_soles_empleado");
                $cta_dolares        = $this->input->post("cta_dolares_empleado");
    
                $cargo              = $this->input->post("cargo_empleado");
                $numero_contrato    = $this->input->post("numero_contrato_empleado");
                $fecha_inicio       = $this->input->post("fecha_inicio_empleado");
                $fecha_final        = $this->input->post("fecha_final_empleado");
            }      
